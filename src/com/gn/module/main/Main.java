...
//        Popover.ctrl.options.getChildren().clear();
    ...
    private void listBookings(){
        ...
        body.setContent(ViewManager.getInstance().get("booking-list"));
    }

    @FXML
    private void packageList(){
        title.setText("Package List");
        body.setContent(ViewManager.getInstance().get("package-list"));
    }
    ...
    private void bookingDetail(){
        ...
        body.setContent(ViewManager.getInstance().get("booking-detail"));
    }

    @FXML
    private void ignorethis(){
        title.setText("New Customers");
        body.setContent(ViewManager.getInstance().get("ignorethis"));
    }

    @FXML
    private void customerList(){
        title.setText("Customers List");
        body.setContent(ViewManager.getInstance().get("customer-list"));
    }

    @FXML
    private void supplierList(){
        title.setText("Suppliers List");
        body.setContent(ViewManager.getInstance().get("supplier-list"));
    }
